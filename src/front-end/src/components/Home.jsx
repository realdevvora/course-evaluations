      ...
      <div className="home--hero">
        ...
        <h3>View ratings on courses you plan to take!</h3>
          <div className="home--review--courses">
            ...
            <MiniCourse name={"BIO152H5 • Introduction to Evolution and Evolutionary Genetics"} description={"The scientific method and the modern theory of evolution as an introduction to biology. The principles of evolution, transmission and evolutionary genetics are developed in lectures and laboratories."} link={"http://localhost:3000/BIO152H5%20%E2%80%A2%20Introduction%20to%20Evolution%20and%20Evolutionary%20Genetics"}/>
